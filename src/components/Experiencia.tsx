        ...
        <div className="space-y-8">
          ...
          <div className="relative pl-8 border-l-2 border-stone-200 dark:border-stone-700 space-y-2">
            ...
            <p className="text-stone-600 dark:text-stone-300 text-sm leading-relaxed">
              Atuação no desenvolvimento de soluções tecnológicas completas, focando em entregas de alta qualidade e performance.
            </p>
          </div>
          ...
          <div className="relative pl-8 border-l-2 border-stone-200 dark:border-stone-700 space-y-2">
            ...
            <div className="flex items-center text-sm text-stone-500 dark:text-stone-400 gap-2">
              <FaCalendarAlt />
              <span>Maio 2025 - Setembro 2025</span>
            </div>
            <p className="text-stone-600 dark:text-stone-300 text-sm leading-relaxed">
              Desenvolvimento e manutenção de sistemas administrativos, contribuindo para a eficiência dos processos internos.
            </p>
          </div>
        </div>
